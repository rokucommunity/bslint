...
_Note: the CLI can be used without adding the `bslint` plugin; you will only
get the default `brighterscript` diagnostics._
...
_Note: it won't remove issues reported by the compiler itself!_
